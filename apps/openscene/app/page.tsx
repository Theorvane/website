...
const runFromSource = ["git clone https://github.com/Theorvane/openscene.git", "cd openscene && npm install", "npm run dev"] as const;
...
const faq = [
	["Does it cost anything?", "OpenScene is free and MIT licensed. Model providers bill you directly if you connect one; the project never sits between you and them."],
