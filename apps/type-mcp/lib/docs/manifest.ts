...
export const sourceCommit = "c13c7c99ab893bbcfdee3d5e88461daf1098e8d5";
...
const documents: readonly PublicDocument[] = [
  ...
  { sourcePath: "docs/guides/langchain-langgraph.md", route: "/docs/guides/langchain-langgraph", title: "LangChain and LangGraph", summary: "Tools-only LangChain adapter and consumer-owned LangGraph ToolNode composition.", group: "Guides", order: 4, classification: "repository-development", sourceStatus: "implemented on this repository's development line" },
  ...
  { sourcePath: "docs/guides/npm-release.md", route: "/docs/guides/npm-release", title: "npm release", summary: "Repository-development release process and package boundary.", group: "Guides", order: 6, classification: "repository-development", sourceStatus: "repository is being prepared" },
