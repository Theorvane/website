...
export default function HomePage() {
	return <><SkipLink />
		<header className="shell"><a className="logo" href="#top">TYPE<span>CHAIN</span></a><nav aria-label="Primary"><a href="#tools">Flow</a><a href="#boundaries">Boundaries</a><a href="/docs">Documentation</a><ExternalLink className="nav-cta" href={github}>GitHub ↗</ExternalLink></nav></header>
...
findProduct({ id }: { id: string }) {
  return catalog.get(id);
		...
		<footer className="site-footer"><div className="shell footer-grid"><div className="footer-brand"><a className="logo" href="#top">TYPE<span>CHAIN</span></a><p>Decorator-first, type-safe authoring for LangChain tools and agents.</p></div><nav aria-label="TypeChain footer" className="footer-nav"><div><strong>Explore</strong><a href="/docs">Documentation</a><a href="/docs/getting-started">Getting started</a></div><div><strong>Project</strong><ExternalLink href={github}>GitHub ↗</ExternalLink><ExternalLink href={npm}>npm ↗</ExternalLink></div><div><strong>Company</strong><ExternalLink href="https://theorvane.tech/">Theorvane ↗</ExternalLink></div></nav></div><div className="shell footer-legal"><span>© 2026 Theorvane. TypeChain is open source.</span><span>Typed tools. Explicit boundaries.</span></div></footer>
	</>;
}
