...
**Goal:** Ship product-specific icon-led landing treatments for TypeMCP, TypeChain, OpenVideo, and a connected Theorvane organization footer.
...
**Files:** Modify `apps/type-mcp/test/home.test.tsx`, `apps/type-chain/test/home.test.tsx`, `apps/openvideo/test/home.test.tsx`, `apps/theorvane/test/home.test.tsx`.
...
### Task 4: Implement OpenVideo approval-surface landing

**Files:** Modify `apps/openvideo/app/page.tsx`, `apps/openvideo/app/globals.css`.
...
3. Run focused OpenVideo tests and confirm GREEN.
...
2. Ensure links target TypeMCP, TypeChain, OpenVideo, principles, and GitHub.
